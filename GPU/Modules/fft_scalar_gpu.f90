...
!     parameters nz, nsl, ldz) are stored and re-used if available
     ...
     IF( .NOT. done ) THEN
       ...
       !idir = -1; CALL CREATE_PLAN_1D_MANY_CUDA( fw_planz( icurrent), nz, idir)
       !idir =  1; CALL CREATE_PLAN_1D_MANY_CUDA( bw_planz( icurrent), nz, idir)
       idir = -1; CALL CREATE_PLAN_1D_CUDA( fw_planz( icurrent), nz, idir)
       idir =  1; CALL CREATE_PLAN_1D_CUDA( bw_planz( icurrent), nz, idir)
